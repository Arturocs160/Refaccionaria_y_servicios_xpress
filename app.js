...
app.get('/api/citas/:date', (req, res) => {
...
app.get('/citas/datos/:num_Cita', (req, res) => {
...
app.get('/consultarInformacionCitas', async(req, res) => {
...
app.delete('/api/cancelar-cita/:num_Cita', (req, res) => {
  const num_Cita = req.params.num_Cita;
